...
async def gbun(event):
    ...
    await event.edit("** Nikal Lawde! Pheli Phursat Mai Nikal**")
    asyncio.sleep(3.5)
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 924138714:
            await reply_message.reply(
                "`Wait a second, This is my master!`\n**How dare you threaten to ban my master nigger!**\n\n__Your account has been hacked! Pay 69$ to my master__ [Roldex](https://t.me/r0ld3x) __to release your account__😏"
            )
        else:
            jnl = (
                "`Warning!! `"
